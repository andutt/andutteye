...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    $out[] = '<embed src="'. $base .'open-flash-chart.swf?data=' . $url .'" quality="high" wmode="transparent" bgcolor="#FFFFFF" width="'. $width .'" height="'. $height .'" name="'. $obj_id .'" align="middle" allowScriptAccess="sameDomain" ';
