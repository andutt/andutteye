...
$sql    = $db->query("select distinct(created_date) from andutteye_alarm where system_name = '$system' and shortinformation = '$alarm' order by seqnr asc limit 0,30");
while ($row = $sql->fetch()) {
...
$g = new graph();
$g->title( "Alarm trend for $alarm on $system without repeatcounts.", '{font-size: 10px; color: #fccc69}' );
